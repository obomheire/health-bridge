  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center mb-8 text-center">
        <h1 className="text-3xl font-bold text-white mb-2">Connect with Doctors</h1>
        <p className="text-muted-foreground text-lg">
          Discover doctors by specialty or browse the complete directory.
        </p>
      </div>
            ...
            <Card className="hover:border-blue-700/40 transition-all cursor-pointer border-blue-900/20 h-full">
              <CardContent className="p-6 flex flex-col items-center justify-center text-center h-full">
                <div className="w-12 h-12 rounded-full bg-blue-900/20 flex items-center justify-center mb-4">
                  <div className="text-blue-500">{specialty.icon}</div>
                </div>
