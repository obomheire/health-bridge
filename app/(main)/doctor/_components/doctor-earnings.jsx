          ...
          <div className="bg-muted/20 p-4 rounded-lg border border-blue-900/20">
            <div className="flex items-center justify-between mb-3">
              ...
              {pendingPayout ? (
                <Badge
                  variant="outline"
                  className="bg-amber-900/20 border-amber-900/30 text-blue-500"
                >
                  PROCESSING
                </Badge>
              ) : (
                <Badge
                  variant="outline"
                  className="bg-blue-900/20 border-blue-900/30 text-blue-500"
                >
                  Available
                </Badge>
              )}
            ...
            {pendingPayout ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                <div>
                  ...
                  <p className="text-blue-500 font-medium">{availableCredits}</p>
                </div>
                <div>
